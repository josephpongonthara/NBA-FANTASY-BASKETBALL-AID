...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan 31 21:28:08 2024

@author: josephpongonthara
"""

#THIS IS THE ARCHIVED FILE FOR THE TEAMS_DATERANGE_GAMES PROGRAM BEFORE JAN 31 2024#
import json
import requests
...
fout = open("NBAteams_gamefrequency.csv", "w")
...
# Specify custom date ranges
    ...
    fout.write('Start Date,End Date,' + ','.join(unique_team_abbreviations) + '\n')
